...
public class BackgroundPanel extends JPanel {
	 ...
	 */
	public BackgroundPanel(final Image image, final int style, final float alignmentX,
	 ...
	 */
	public final void setImageAlignmentX(final float alignmentX) {
	 ...
	 * Specify the horizontal alignment of the image when using ACTUAL style
	 */
	public final void setImageAlignmentY(final float alignmentY) {
	 ...
	 * Override method so we can make the component transparent
	 */
	public final void add(final JComponent component, final Object constraints) {
		if (isTransparentAdd) {
	 ...
	 * is set to true.
	 */
	public final void setTransparentAdd(final boolean isTransparentAdd) {
